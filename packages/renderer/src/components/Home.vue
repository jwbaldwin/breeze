<template>
  <div class="flex-1 min-w-0 bg-white">
    <div class="px-6 pt-6 pb-4 border-t border-b border-gray-200">
    ...
    <ul class="relative z-0 border-b border-gray-200 divide-y divide-gray-200">
      <li class="relative px-6 py-5 hover:bg-gray-50">
        <div class="flex items-center justify-between space-x-4">
          ...
          <!-- Repo meta info -->
          <div class="flex-col items-end flex-shrink-0 hidden space-y-3">
